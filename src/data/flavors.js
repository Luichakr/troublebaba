...
export const INGREDIENTS_BY_SLUG = {
  'oreo-bento-cake': {
    uk: ['какао-порошок', 'вершковий сир', 'вершки 33–36%', 'печиво Oreo', 'вишня'],
    ru: ['какао-порошок', 'сливочный сыр', 'сливки 33–36%', 'печенье Oreo', 'вишня'],
  },
  'red-velvet-bento-cake': {
    uk: ['какао-порошок', 'харчовий барвник', 'маскарпоне', 'вершки 33–36%', 'полуниця'],
    ru: ['какао-порошок', 'пищевой краситель', 'маскарпоне', 'сливки 33–36%', 'клубника'],
  },
  'poppy-seed-citrus-bento-cake': {
    uk: ['мелений мак', 'цедра лимона', 'лимонний сік', 'цедра апельсина', 'апельсиновий сік', 'білий шоколад', 'вершковий сир'],
    ru: ['молотый мак', 'цедра лимона', 'лимонный сок', 'цедра апельсина', 'апельсиновый сок', 'белый шоколад', 'сливочный сыр'],
  },
  'snickers-bento-cake': {
    uk: ['какао-порошок', 'вершковий сир', 'вершки 33–36%', 'молочний шоколад', 'глюкозний сироп', 'морська сіль', 'смажений солоний арахіс'],
    ru: ['какао-порошок', 'сливочный сыр', 'сливки 33–36%', 'молочный шоколад', 'глюкозный сироп', 'морская соль', 'жареный солёный арахис'],
  },
  'raffaello-bento-cake': {
    uk: ['мигдальне борошно', 'кокосова стружка', 'білий шоколад', 'вершки 33–36%', 'маскарпоне', 'мигдаль', 'хрустка вафля'],
    ru: ['миндальная мука', 'кокосовая стружка', 'белый шоколад', 'сливки 33–36%', 'маскарпоне', 'миндаль', 'хрустящая вафля'],
  },
  'ferrero-rocher-bento-cake': {
    uk: ['какао-порошок', 'вершки 33–36%', 'молочний шоколад', 'фундук', 'хрустка вафля'],
    ru: ['какао-порошок', 'сливки 33–36%', 'молочный шоколад', 'фундук', 'хрустящая вафля'],
  },
  'cinnabon-bento-cake': {
    uk: ['коричневий цукор', 'кориця', 'волоські горіхи', 'вершковий сир'],
    ru: ['коричневый сахар', 'корица', 'грецкие орехи', 'сливочный сыр'],
  },
  'pistachio-raspberry-bento-cake': {
    uk: ['фісташкова паста', 'фісташки', 'малина', 'вершки 33–36%', 'білий шоколад', 'маскарпоне'],
    ru: ['фисташковая паста', 'фисташки', 'малина', 'сливки 33–36%', 'белый шоколад', 'маскарпоне'],
  },
  'pina-colada-bento-cake': {
    uk: ['кокосова стружка', 'ананас (свіжий або консервований)', 'білий ром', 'цедра лайма', 'вершки 33–36%', 'білий шоколад', 'маскарпоне'],
    ru: ['кокосовая стружка', 'ананас (свежий или консервированный)', 'белый ром', 'цедра лайма', 'сливки 33–36%', 'белый шоколад', 'маскарпоне'],
  },
  'cherry-chocolate-bento-cake': {
    uk: ['какао-порошок', 'вишня', 'темний шоколад', 'вершки 33–36%'],
    ru: ['какао-порошок', 'вишня', 'тёмный шоколад', 'сливки 33–36%'],
  },
};
