...
export const INGREDIENTS_BY_SLUG = {
  'oreo-bento-cake': {
    uk: ['борошно', 'какао-порошок', 'цукор', 'ванільний цукор', 'розпушувач', 'сіль', 'яйце', 'молоко', 'вершкове масло 82%', 'соняшникова олія', 'вершковий сир', 'вершки 33–36%', 'цукрова пудра', 'печиво Oreo', 'вишня', 'крохмаль'],
    ru: ['мука', 'какао-порошок', 'сахар', 'ванильный сахар', 'разрыхлитель', 'соль', 'яйцо', 'молоко', 'сливочное масло 82%', 'подсолнечное масло', 'сливочный сыр', 'сливки 33–36%', 'сахарная пудра', 'печенье Oreo', 'вишня', 'крахмал'],
  },
  'red-velvet-bento-cake': {
    uk: ['борошно', 'какао-порошок', 'цукор', 'розпушувач', 'сода', 'сіль', 'яйце', 'молоко', 'рослинна олія', 'оцет', 'ванільний цукор', 'харчовий барвник', 'маскарпоне', 'вершки 33–36%', 'цукрова пудра', 'полуниця'],
    ru: ['мука', 'какао-порошок', 'сахар', 'разрыхлитель', 'сода', 'соль', 'яйцо', 'молоко', 'растительное масло', 'уксус', 'ванильный сахар', 'пищевой краситель', 'маскарпоне', 'сливки 33–36%', 'сахарная пудра', 'клубника'],
  },
  'poppy-seed-citrus-bento-cake': {
    uk: ['борошно', 'цукор', 'розпушувач', 'яйце', 'молоко', 'рослинна олія', 'мелений мак', 'цедра лимона', 'лимонний сік', 'цедра апельсина', 'апельсиновий сік', 'вершкове масло 82%', 'білий шоколад', 'вершковий сир', 'цукрова пудра'],
    ru: ['мука', 'сахар', 'разрыхлитель', 'яйцо', 'молоко', 'растительное масло', 'молотый мак', 'цедра лимона', 'лимонный сок', 'цедра апельсина', 'апельсиновый сок', 'сливочное масло 82%', 'белый шоколад', 'сливочный сыр', 'сахарная пудра'],
  },
  'snickers-bento-cake': {
    uk: ['борошно', 'какао-порошок', 'цукор', 'ванільний цукор', 'розпушувач', 'сіль', 'яйце', 'молоко', 'соняшникова олія', 'вершкове масло 82%', 'вершковий сир', 'вершки 33–36%', 'цукрова пудра', 'молочний шоколад', 'глюкозний сироп', 'морська сіль', 'смажений солоний арахіс'],
    ru: ['мука', 'какао-порошок', 'сахар', 'ванильный сахар', 'разрыхлитель', 'соль', 'яйцо', 'молоко', 'подсолнечное масло', 'сливочное масло 82%', 'сливочный сыр', 'сливки 33–36%', 'сахарная пудра', 'молочный шоколад', 'глюкозный сироп', 'морская соль', 'жареный солёный арахис'],
  },
  'raffaello-bento-cake': {
    uk: ['яйце', 'цукор', 'ванільний або кокосовий цукор', 'борошно', 'мигдальне борошно', 'кокосова стружка', 'рослинна олія', 'розпушувач', 'білий шоколад', 'вершки 33–36%', 'маскарпоне', 'мигдаль', 'хрустка вафля'],
    ru: ['яйцо', 'сахар', 'ванильный или кокосовый сахар', 'мука', 'миндальная мука', 'кокосовая стружка', 'растительное масло', 'разрыхлитель', 'белый шоколад', 'сливки 33–36%', 'маскарпоне', 'миндаль', 'хрустящая вафля'],
  },
  'ferrero-rocher-bento-cake': {
    uk: ['борошно', 'какао-порошок', 'цукор', 'ванільний цукор', 'розпушувач', 'сіль', 'яйце', 'молоко', 'соняшникова олія', 'вершкове масло 82%', 'вершки 33–36%', 'молочний шоколад', 'фундук', 'хрустка вафля'],
    ru: ['мука', 'какао-порошок', 'сахар', 'ванильный сахар', 'разрыхлитель', 'соль', 'яйцо', 'молоко', 'подсолнечное масло', 'сливочное масло 82%', 'сливки 33–36%', 'молочный шоколад', 'фундук', 'хрустящая вафля'],
  },
  'cinnabon-bento-cake': {
    uk: ['борошно', 'цукор', 'коричневий цукор', 'розпушувач', 'сіль', 'яйце', 'молоко', 'рослинна олія', 'кориця', 'вершкове масло 82%', 'волоські горіхи', 'вершковий сир', 'цукрова пудра'],
    ru: ['мука', 'сахар', 'коричневый сахар', 'разрыхлитель', 'соль', 'яйцо', 'молоко', 'растительное масло', 'корица', 'сливочное масло 82%', 'грецкие орехи', 'сливочный сыр', 'сахарная пудра'],
  },
  'pistachio-raspberry-bento-cake': {
    uk: ['борошно', 'цукор', 'розпушувач', 'яйце', 'молоко', 'рослинна олія', 'фісташкова паста', 'фісташки', 'малина', 'крохмаль', 'вершки 33–36%', 'білий шоколад', 'маскарпоне'],
    ru: ['мука', 'сахар', 'разрыхлитель', 'яйцо', 'молоко', 'растительное масло', 'фисташковая паста', 'фисташки', 'малина', 'крахмал', 'сливки 33–36%', 'белый шоколад', 'маскарпоне'],
  },
  'pina-colada-bento-cake': {
    uk: ['борошно', 'цукор', 'розпушувач', 'яйце', 'молоко', 'рослинна олія', 'кокосова стружка', 'ананас (свіжий або консервований)', 'білий ром', 'цедра лайма', 'вершки 33–36%', 'білий шоколад', 'маскарпоне'],
    ru: ['мука', 'сахар', 'разрыхлитель', 'яйцо', 'молоко', 'растительное масло', 'кокосовая стружка', 'ананас (свежий или консервированный)', 'белый ром', 'цедра лайма', 'сливки 33–36%', 'белый шоколад', 'маскарпоне'],
  },
  'cherry-chocolate-bento-cake': {
    uk: ['борошно', 'какао-порошок', 'цукор', 'ванільний цукор', 'розпушувач', 'сіль', 'яйце', 'молоко', 'вершкове масло 82%', 'соняшникова олія', 'вишня', 'крохмаль', 'темний шоколад', 'вершки 33–36%'],
    ru: ['мука', 'какао-порошок', 'сахар', 'ванильный сахар', 'разрыхлитель', 'соль', 'яйцо', 'молоко', 'сливочное масло 82%', 'подсолнечное масло', 'вишня', 'крахмал', 'тёмный шоколад', 'сливки 33–36%'],
  },
};
...
export const INGREDIENTS_COPY = {
  uk: {
    ...
    subline:  'Тільки назви продуктів. Точні грами й пропорції — у платному PDF-збірнику.',
  ...
  ru: {
    ...
    subline:  'Только названия продуктов. Точные граммы и пропорции — в платном PDF-сборнике.',
