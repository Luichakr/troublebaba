...
export const INGREDIENTS_BY_SLUG = {
  'oreo-bento-cake': {
    uk: ['борошно', 'цукор', 'ванільний цукор', 'розпушувач', 'сіль', 'яйце', 'молоко', 'вершкове масло 82%', 'соняшникова олія', 'цукрова пудра', 'крохмаль'],
    ru: ['мука', 'сахар', 'ванильный сахар', 'разрыхлитель', 'соль', 'яйцо', 'молоко', 'сливочное масло 82%', 'подсолнечное масло', 'сахарная пудра', 'крахмал'],
  },
  ...
  'poppy-seed-citrus-bento-cake': {
    uk: ['борошно', 'цукор', 'розпушувач', 'яйце', 'молоко', 'рослинна олія', 'вершкове масло 82%', 'цукрова пудра'],
    ru: ['мука', 'сахар', 'разрыхлитель', 'яйцо', 'молоко', 'растительное масло', 'сливочное масло 82%', 'сахарная пудра'],
  },
  'snickers-bento-cake': {
    uk: ['борошно', 'цукор', 'ванільний цукор', 'розпушувач', 'сіль', 'яйце', 'молоко', 'соняшникова олія', 'вершкове масло 82%', 'цукрова пудра'],
    ru: ['мука', 'сахар', 'ванильный сахар', 'разрыхлитель', 'соль', 'яйцо', 'молоко', 'подсолнечное масло', 'сливочное масло 82%', 'сахарная пудра'],
  },
  ...
  'ferrero-rocher-bento-cake': {
    uk: ['борошно', 'цукор', 'ванільний цукор', 'розпушувач', 'сіль', 'яйце', 'молоко', 'соняшникова олія', 'вершкове масло 82%'],
    ru: ['мука', 'сахар', 'ванильный сахар', 'разрыхлитель', 'соль', 'яйцо', 'молоко', 'подсолнечное масло', 'сливочное масло 82%'],
  },
  'cinnabon-bento-cake': {
    uk: ['борошно', 'цукор', 'розпушувач', 'сіль', 'яйце', 'молоко', 'рослинна олія', 'вершкове масло 82%', 'цукрова пудра'],
    ru: ['мука', 'сахар', 'разрыхлитель', 'соль', 'яйцо', 'молоко', 'растительное масло', 'сливочное масло 82%', 'сахарная пудра'],
  },
  ...
  'cherry-chocolate-bento-cake': {
    uk: ['борошно', 'цукор', 'ванільний цукор', 'розпушувач', 'сіль', 'яйце', 'молоко', 'вершкове масло 82%', 'соняшникова олія', 'крохмаль'],
    ru: ['мука', 'сахар', 'ванильный сахар', 'разрыхлитель', 'соль', 'яйцо', 'молоко', 'сливочное масло 82%', 'подсолнечное масло', 'крахмал'],
  },
};
